			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<td width="3" class="ForumPageTableTitleLeft">&nbsp;</td>
					...
					<td class="ForumPageTableTitle" align="right" style="padding-right:12px;">
						...
						<s:a action="forum_moveUI?topicId=%{#topic.id}"><img border="0" src="${pageContext.request.contextPath}/style/images/edit.gif" />移动到其他版块</s:a>
						<s:a action="topic_changeType?topicId=%{#topic.id}&key=1" onClick="return confirm('要把本主题设为精华吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/topicType_1.gif" />精华</s:a>
						<s:a action="topic_changeType?topicId=%{#topic.id}&key=2" onClick="return confirm('要把本主题设为置顶吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/topicType_2.gif" />置顶</s:a>
						<s:a action="topic_changeType?topicId=%{#topic.id}&key=0" onClick="return confirm('要把本主题设为普通吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/topicType_0.gif" />普通</s:a>
					</td>
						...
						<td align="center">
							<ul class="TopicFunc">
								...
								<li class="TopicFuncLi">
									<s:a class="detail" action="topic_editUI?topicId=%{#topic.id}"><img border="0" src="${pageContext.request.contextPath}/style/images/edit.gif" />编辑</s:a>
									<s:a class="detail" action="topic_delete?topicId=%{#topic.id}" onClick="return confirm('确定要本帖吗？')"><img border="0" src="${pageContext.request.contextPath}/style/images/delete.gif" />删除</s:a>
								</li>
								<!-- 文章的标题 -->
...
<!--快速回复
	...
	<form action="reply_add?topicId=%{#topic.id}">
