...
public class UserAction extends BaseAction<User> {
	 ...
	 * @throws Exception
	 */
	public String uservipmanager() throws Exception {
	...
	public String listpart() throws Exception {
		...
		rowCount = userService.getRowCount();
		...
		ActionContext.getContext().put("userpart", userService.getList(pageNow, pageSize));
	...
	public String listall() throws Exception {
		...
		ActionContext.getContext().put("userall", userService.getById(model.getId()));
	...
	public String query() throws Exception {
		...
		ActionContext.getContext().put("userByTrueName", userService.queryByTrueName(model.getTrueName()));
